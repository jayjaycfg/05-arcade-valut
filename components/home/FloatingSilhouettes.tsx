// Decorative pixel silhouettes of classic arcade shapes. Purely visual, so
// the whole group is hidden from assistive technology.
export function FloatingSilhouettes() {
	return (
		<div aria-hidden="true" className="home-silos">
			<svg aria-hidden="true" className="silo s1" viewBox="0 0 40 32">
				<g fill="#00f5ff">
			...
			<svg aria-hidden="true" className="silo s2" viewBox="0 0 32 32">
				<g fill="#ff006e">
			...
			<svg aria-hidden="true" className="silo s3" viewBox="0 0 32 32">
				<g fill="#f5ff00">
			...
			<svg aria-hidden="true" className="silo s4" viewBox="0 0 24 24">
				<g fill="#00ff88">
			...
			<svg aria-hidden="true" className="silo s5" viewBox="0 0 36 24">
				<g fill="#aa00ff">
			...
			<svg aria-hidden="true" className="silo s6" viewBox="0 0 20 20">
				<g fill="#ffcf3a">
			...
			<svg aria-hidden="true" className="silo s7" viewBox="0 0 24 22">
				<g fill="#ff3060">
			...
			<svg aria-hidden="true" className="silo s8" viewBox="0 0 24 24">
				<g fill="#00d4ff">
